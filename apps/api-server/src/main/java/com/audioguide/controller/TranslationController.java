...
public class TranslationController {
    ...
    ApiResponse<UiLanguageListResponse> getUiLanguages() {
        return ApiResponse.<UiLanguageListResponse>builder()
                .message("Get UI languages successfully")
                .result(uiTranslationService.getSupportedUiLanguages())
                .build();
    }
}
